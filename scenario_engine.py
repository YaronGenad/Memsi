...
#
# Sprint C7.9: הרשימה הזאת **בכוונה שונה** מ-causal_forecast.CORE_BRANCHES
# (שיש לו גם '800' = יציאת התעופה). compute_conversion_rates משתמש ב-8
# הסניפים שלמטה כדי לחשב median rate על "retail floor branches" בלבד —
# בלי לכלול את '800' שהוא warehouse-של-יציאה ולא retail. ה-causal model
# משתמש ב-9 (כולל 800) כי הוא מודד כל-pool-נחתות כולל יצואים.
# אם משנים את הרשימה הזאת, לבדוק שגם ה-rate מאותרגל מחדש.
